...
<html>
  <head>
    ...
    <title>My JSP 'user_onlyedit.jsp' starting page</title>
...
$(document).ready(function(){
	...
	$("#pid").formValidator({ajax:true,onShow:"请输入15或18位的身份证",onFocus:"输入15或18位的身份证",onCorrect:"输入正确"}).functionValidator({fun:isCardID});
  ...
  <tr>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[用户中心]-[个人信息]</td>
              </tr>
            </table></td>
   ...
   <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <s:form action="user!onlyUpdate" name="form1" id="form1" theme="simple" namespace="/oa">
          ...
          <tr align="center"  height="30">
		    <td colspan="3" background="main/tab/images/bg.gif" bgcolor="#FFFFFF">用户信息</td>
		  </tr>
		  <tr height="30">
		  ...
		  <tr height="30">
		    ...
		    <td bgcolor="#FFFFFF"><s:textfield  id="realname" name="realname" readonly="true"/></td>
		    <td bgcolor="#FFFFFF"><div id="realnameTip" style="width:280px"></div></td>
		  </tr>
		  <tr height="30" >
		    <td align="right" bgcolor="#FFFFFF">所属部门：</td>
		    <td bgcolor="#FFFFFF"><s:select id="did" list="datalist.{? #this.dpid==1}" name="deptno" headerKey="0" headerValue="请选择" listKey="did" listValue="dname" readonly="true"></s:select></td>
		    <td bgcolor="#FFFFFF"><div id="didTip" style="width:280px"></div></td>
		  </tr>
		  <tr height="30">
		    <td align="right" bgcolor="#FFFFFF" >岗位：</td>
		    <td bgcolor="#FFFFFF" ><s:select id="jid" list="datalist.{? #this.dpid==2}" name="jobno" headerKey="0" headerValue="请选择" listKey="did" listValue="dname" readonly="true"></s:select>
		    </td>
		    <td bgcolor="#FFFFFF" ><div id="jidTip" style="width:280px"></div></td>
		  </tr>
		  <tr height="30">
		    <td align="right" bgcolor="#FFFFFF">性别：</td>
		    <td bgcolor="#FFFFFF"><s:radio id="sex" name="sex" list="#{'1':'男','2':'女'}" readonly="true"></s:radio> </td>
		    <td bgcolor="#FFFFFF"><div id="sexTip" style="width:280px"></div></td>
		  </tr>
		  <tr height="30">
		    <td align="right" bgcolor="#FFFFFF" >婚否：</td>
		    <td bgcolor="#FFFFFF"><s:radio id="married" name="married" list="#{'1':'未婚','2':'已婚'  }" readonly="true"></s:radio> </td>
		    <td bgcolor="#FFFFFF"><div id="marriedTip" style="width:280px"></div></td>
		  </tr>
		  <tr bgcolor="#FFFFFF" height="30">
		    <td align="right">籍贯：</td>
		    <td>
		    	<s:select list="datalist.{? #this.dpid==29}" id="city" name="city" headerKey="" headerValue="请选择" listKey="did" listValue="dname" readonly="true"></s:select>
		    </td>
		    <td><div id="cityTip" style="width:280px"></div></td>
		  </tr>
		  <tr bgcolor="#FFFFFF" height="30">
		    <td align="right">身份证：</td>
		    <td><s:textfield id="pid" name="idcard" readonly="true"> </s:textfield></td>
		    <td><div id="pidTip" style="width:280px"></div></td>
		  </tr>
		  <tr bgcolor="#FFFFFF" height="30" >
		    <td align="right">联系电话：</td>
		    <td><s:textfield id="telephone" name="telephone" readonly="true"></s:textfield></td>
		    <td><div id="telephoneTip" style="width:280px"></div></td>
		  </tr>
		  <tr bgcolor="#FFFFFF" height="30">
		    <td align="right">e-mail：</td>
		    <td><s:textfield id="email" name="email" readonly="true"></s:textfield></td>
		    <td><div id="emailTip" style="width:280px"></div></td>
		  </tr>
		  <tr bgcolor="#FFFFFF" height="30">
		    <td align="right">手机：</td>
		    <td><s:textfield id="mobile" name="mobilephone" readonly="true"></s:textfield></td>
		    <td><div id="mobileTip" style="width:280px"/></div></td>
		  </tr>
		  <tr bgcolor="#FFFFFF" height="30">
		    <td align="right">住址：</td>
		    <td><s:textfield id="address" name="address" readonly="true"></s:textfield></td>
		    <td><div id="addressTip" style="width:280px"></div></td>
		  </tr>
		  <tr align="center" bgcolor="#FFFFFF" height="30">
		    <td colspan="2"><s:submit value="修改"/><input type="button" onclick="history.back();" value="返回"></td>
