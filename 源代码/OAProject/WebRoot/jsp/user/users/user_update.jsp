...
$(document).ready(function(){
	...
	$("#pid").formValidator({ajax:true,onShow:"请输入15或18位的身份证",onFocus:"输入15或18位的身份证",onCorrect:"输入正确"}).regexValidator({regExp:"^[1-9][0-9]{5}(19[0-9]{2}|200[0-9]|2010)(0[1-9]|1[0-2])(0[1-9]|[12][0-9]|3[01])[0-9]{3}[0-9xX]$"});
	...
	$("#rid").formValidator({relativeID:"qq5",tipID:"ridTip",tipCss :{"left":"116px"},onShow:"请为其授予角色（至少选一个）",onFocus:"你至少选择1个",onCorrect:"恭喜你,你选对了"}).inputValidator({min:1,onError:"你选的个数不对"});
     ...
     function back(){
        parent.mainFrame.I1.location.href="<%=path%>/oa/user!dotag";
     }
      ...
      <td>
        <s:form action="user!onlyUpdate" name="form1" id="form1" theme="simple" namespace="/oa">
		  ...
		  <tr height="30">
		    ...
		    <td width="39%" bgcolor="#FFFFFF"><s:textfield  id="username" name="username" /></td>
		  ...
		  <tr height="30" >
		    ...
		    <td bgcolor="#FFFFFF"><s:select id="did" list="datalist.{? #this.dpid==3}" name="deptno" headerKey="0" headerValue="请选择" listKey="did" listValue="dname"></s:select></td>
		  ...
		  <tr bgcolor="#FFFFFF" height="30">
		    ...
		    <td>
		    	<s:select list="datalist.{? #this.dpid==1}" id="city" name="city" headerKey="" headerValue="请选择" listKey="did" listValue="dname"></s:select>
		    </td>
		  ...
		  <tr align="center" bgcolor="#FFFFFF" height="30">
		    <td colspan="2"><s:submit value="修改"></s:submit><s:reset value="重置"></s:reset><input type="button" onclick="history.back();" value="返回"></td>
