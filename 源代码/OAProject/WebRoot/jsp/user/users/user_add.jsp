...
$(document).ready(function(){
	...
	$.formValidator.initConfig({formID:"form1",onError:function(){alert("校验没有通过，具体错误请看错误提示")}});
        ...
        async : true,
        cache:false,
		url : "<%=path %>/oa/user!checkUsername.action?date="+new Date().getTime(),
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[<a href="<%=path %>/oa/userlist!view">用户管理</a>]-[<a href="<%=path %>/oa/user!init">添加用户</a>]</td>
              </tr>
            </table></td>
        ...
        <s:form action="user!saveOrUpdate" name="form1" id="form1" theme="simple" namespace="/oa">
		  ...
		  <tr bgcolor="#FFFFFF" height="30" >
			   ...
			   <s:iterator value="rolelist" var="item">
				...
				<s:if test="roleid in roleidlist"> checked="checked"</s:if>/>
				<s:property value="#item.rolename" /></div>
